    ...
    <section id="contact" className="bg-[#121212] py-20 md:py-24 px-4 md:px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-[#0a0a0a] rounded-[30px] md:rounded-[40px] overflow-hidden shadow-2xl flex flex-col lg:flex-row border border-white/5">
          ...
          <div className="lg:w-1/2 p-8 md:p-16 flex flex-col justify-center">
            ...
            <div className="space-y-6 md:space-y-8 mb-10 md:mb-14">
              <div className="flex items-start gap-4 md:gap-5">
                {/* Icon sizing fix for build error */}
                ...
                <div className="text-gray-300 text-base md:text-xl font-medium">
                  <a href="tel:+919836421193" className="hover:text-white transition-colors block">+91 98364 21193</a>
                  <a href="tel:+917980383184" className="hover:text-white transition-colors block">+91 79803 83184</a>
                </div>
              </div>

              <div className="flex items-center gap-4 md:gap-5">
                <Mail className="text-[#c5a04d] shrink-0 w-6 h-6 md:w-7 md:h-7" />
                <a href="mailto:sagardas811980@gmail.com" className="text-gray-300 text-base md:text-xl font-medium break-all hover:text-white transition-colors">
            ...
            <div className="flex flex-col md:flex-row gap-4 w-full">
              <a href="tel:+919836421193" className={goldenBtnStyle}>
                <Phone className="w-5 h-5" /> Call Now
              </a>

              <a href="https://wa.me/919836421193" target="_blank" rel="noopener noreferrer" className={whatsappBtnStyle}>
          ...
          {/* Map section using requested coordinates */}
          <div className="lg:w-1/2 h-87.5 md:h-auto min-h-100 p-4 md:p-12">
            <div className="w-full h-full rounded-[25px] md:rounded-[30px] overflow-hidden border-2 border-[#c5a04d]/40 shadow-[0_0_40px_rgba(197,160,77,0.3)]">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d230.34489687381205!2d88.3941769527695!3d22.52224741869687!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a0277fd71529783%3A0x24e7bf68c30790de!2sRudra%20Interior%20%26%20Exterior!5e0!3m2!1sen!2sin!4v1772472953171!5m2!1sen!2sin"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen=""
