...
const GetInTouch = () => {
  // Enhanced button style with golden border glow and cursor pointer
  ...
  // WhatsApp specific style: Green background, white text, golden glow
  ...
  return (
    <section className="bg-[#121212] py-24 px-6 animate-diagonal-gold">
      <div className="max-w-7xl mx-auto">
        {/* Section Title */}
        <h2 className="text-white text-4xl md:text-6xl font-bold text-center mb-20 uppercase tracking-tight">
        ...
        <div className="bg-[#0a0a0a] rounded-[40px] overflow-hidden shadow-2xl flex flex-col lg:flex-row border border-white/5 min-h-[550px]">
          ...
          <div className="lg:w-1/2 p-10 md:p-16 flex flex-col justify-center">
            <h3 className="text-white text-3xl font-bold mb-10">Contact Sagar Das</h3>
            
            <div className="space-y-8 mb-14">
              {/* Phone */}
              <div className="flex items-start gap-5">
                <Phone className="text-[#c5a04d] mt-1" size={28} />
              ...
              <div className="flex items-center gap-5">
                <Mail className="text-[#c5a04d]" size={28} />
                <p className="text-gray-300 text-lg md:text-xl font-medium">sagardas811980@gmail.com</p>
              </div>

              {/* Address */}
              <div className="flex items-start gap-5">
                <MapPin className="text-[#c5a04d] mt-1" size={28} />
                <p className="text-gray-300 text-lg md:text-xl font-medium">Laketown, Kolkata, West Bengal</p>
              </div>
            </div>

            {/* Buttons: All in one line with border glows */}
            <div className="flex flex-row gap-4 w-full">
              ...
              {/* WhatsApp Button - Green with White Content */}
