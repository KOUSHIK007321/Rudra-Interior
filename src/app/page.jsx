    ...
    <main className="relative min-h-screen w-full overflow-hidden bg-black">
      ...
      <div className="relative z-20">
        ...
        <div className="flex justify-center lg:pt-4">
          <div
            className="bg-yellow-400 text-black w-full md:w-[85%] rounded-none md:rounded-2xl px-4 md:px-8 py-2 md:py-3"
          >
            <div className="grid grid-cols-1 md:grid-cols-3 items-center">

              <div className="hidden md:block text-sm font-medium">
                <h1 className="text-center text-4xl md:text-6xl font-bold text-white mb-16">
                  Rudra  <span className="text-yellow-400">Interior</span>
                </h1>
              </div>
        ...
        <div className="w-full md:w-[85%] mx-auto mt-6 md:mt-10 px-6 md:px-20 flex items-center justify-between text-white">
          ...
          <div className="flex justify-center text-center">
            ...
            <h1 className="flex items-center text-2xl md:text-5xl font-bold text-white gap-3.5">
              Rudra <span className="text-yellow-400">Interior</span>
            </h1>
